...
Below uses United States Social Security Administration data [available from SSA.gov](https://www.ssa.gov/oact/babynames/limits.html) - first names only, and per SSA, "All names are from Social Security card applications for births that occurred in the United States."
...
# Most gender-neutral names for each year of birth

See the `most_neutral_names_by_yob` folder for data files corresponding to each year.
